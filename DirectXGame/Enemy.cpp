...
void Enemy::MapCollisionDetectionUp(CollisionMapInfo& info) {
	// 上昇あり？
...
void Enemy::MapCollisionDetectionDown(CollisionMapInfo& info) {
	// 移動後の4つの角の座標
	std::array<Vector3, kNumCorner> positionsNew;
...
void Enemy::MapCollisionDetectionRight(CollisionMapInfo& info) {
...
void Enemy::MapCollisionDetectionLeft(CollisionMapInfo& info) {
...
void Enemy::WallContactProcess(const CollisionMapInfo& info) {
	// 壁接触による減速
...
// 接地状態の切り替え処理
void Enemy::GroundingStateSwitching(const CollisionMapInfo& info) {
...
void Enemy::MoveJudgmentResults(const CollisionMapInfo& info) {
	// 移動
